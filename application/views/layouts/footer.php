...
<script>
    $(document).ready(function() {
        ...
        $(".btn-edit-product").on("click", function() {
            ...
            html = `<div class="row">
                    <div class="col-md-12">
                        <form action="`+base_url+`admin/productos_c/edit" method="post">
                            <input  type="text"  class="invisible" name="id" value="`+viewPro[0]+`" class="form-control">
                            <div class="form-group">
                                <label for="nombre">Name:</label>
                                <input type="text" value="`+viewPro[1]+`" name="name" class="form-control" id="name">
                            </div>
                            <div class="form-group">
                                <label for="description">Description:</label>
                                <textarea name="description" id="description" cols="10" rows="5" class="form-control">`+viewPro[2]+`</textarea>
                            </div>
                            <div class="form-group">
                                <label for="price">Price:</label>
                                <input type="text" name="price" value="`+viewPro[4]+`" class="form-control" id="price">
                            </div>
                            <div class="form-group">
                                <label for="amount">Amount:</label>
                                <input type="text" name="amount" value="`+viewPro[3]+`" class="form-control" id="amount">
                            </div>
