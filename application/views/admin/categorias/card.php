                           ...
                           <div class="card-footer" style="height: 3rem; ;">
                            ...
                            <div class="card-footer" style="background-color:darkgray">
                                ...
                                <a href="#" class="btn btn-dark btn-sm ">Add</a>
                                    <button type="button" value="<?php echo $dataPro?>" 
                                    class="btn btn-primary btn-danger btn-sm btn-view-product" data-toggle="modal" 
                                    data-target="#exampleModal2" style="float: right; color: white;">
                                    Delete
                                 </button>
